...
sudo mkdir -p /home/samples; sudo git clone -b $GIT_BRANCH --depth 1 https://github.com/dem108/build2023demo-moe-models.git /home/samples/build2023demo-moe-models -q
